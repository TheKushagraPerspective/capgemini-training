...
class Mini extends Ola{
    ...
    public Mini(String username , long contactNumber , double uberAccBal , String pickUpPoint , String dropPoint) {
        super(username , contactNumber , uberAccBal);
        this.pickUpPoint = pickUpPoint;
        this.dropPoint = dropPoint;
    }

    public void setMiniObjReference(Mini obj) {
        this.mini = obj;
    }
    ...
    public void cancelRide(Mini obj) {
        // if(obj.price > 0) {
