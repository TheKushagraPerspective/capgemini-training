...
All microservices such as **Loan Service, Customer Service, Demat Account Service, Gateway Service, etc.** register themselves with Eureka so that they can discover and communicate with each other.
...
Client → Gateway Service → Eureka Server → Microservices
