...
class Luxury extends Ola {
    ...
    public Luxury(String username , long contactNumber , double uberAccBal , String pickUpPoint , String dropPoint) {
    ...
    public void displayDetails() {
        ...
        if(this.cabBooked) {
            System.out.println(super.getUserName() + " customer has bocoked the cab from " + this.getPickUpPoint() + " to " + this.getDropPoint());
        }
        else {
    ...
    public void cancelRide(Luxury obj) {
        if(obj.price > 0) {
